...
class Evaluate:
    def __init__(self, label_list, prediction_list, IoU_threshold, gap_threshold):
    ...
    def main(self):
        ...
        Prec.to_csv('/home/mathieu/Documents/meetings and logs/metrics/Precision.csv')
        Rec.to_csv('/home/mathieu/Documents/meetings and logs/metrics/Recall.csv')
        cat_frag.to_csv('/home/mathieu/Documents/meetings and logs/metrics/Category fragmentation.csv')
        time_frag.to_csv('/home/mathieu/Documents/meetings and logs/metrics/Time fragmentation.csv')
        cf.to_csv('/home/mathieu/Documents/meetings and logs/metrics/Confusion matrix.csv')
        gt_indices.to_csv('/home/mathieu/Documents/meetings and logs/metrics/Ground truth.csv')
        pred_indices.to_csv('/home/mathieu/Documents/meetings and logs/metrics/Predictions.csv')
        with open("/home/mathieu/Documents/meetings and logs/metrics/Matching table.txt", "wb") as fp:   #Pickling
            pickle.dump(match, fp)
        with open("/home/mathieu/Documents/meetings and logs/metrics/Time difference.txt", "wb") as fp:   #Pickling
